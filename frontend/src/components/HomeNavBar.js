    ...
    <header id="header" className="fixed-top d-flex align-items-center">
      <div className="container d-flex justify-content-between">
        ...
        <nav id="navbar" className="navbar">
          <ul>
            <li><a id="home-nav" className="nav-link" href="/">Home</a></li>
            <li><a id="about-nav" className="nav-link" href="/about">About</a></li>
            <li><a id="services-nav" className="nav-link" href="/services">Services</a></li>
            ...
            <li><a id="team-nav" className="nav-link" href="/team">Team</a></li>
            <li><a id="team-nav" className="nav-link" href="/suppliers">Suppliers</a></li>
                      ...
                      : (
                        <>
                          ...
                          {categories.map((category) => (
                            <li key={Math.random()}><Link to={"/search/category/" + category._id}>{category.name}</Link></li>
                          ))}
                        </>
                      )
                }
            ...
            <li><a id="contact-nav" className="nav-link" href="/contact">Contact</a></li>
