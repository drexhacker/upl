...
export const PRODUCT_LIST_POPULAR_REQUEST = 'PRODUCT_POPULAR_LIST_REQUEST';
export const PRODUCT_LIST_POPULAR_SUCCESS = 'PRODUCT_POPULAR_LIST_SUCCESS';
export const PRODUCT_LIST_POPULAR_FAIL = 'PRODUCT_POPULAR_LIST_FAIL';
